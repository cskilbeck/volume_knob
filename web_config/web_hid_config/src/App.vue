...
<template>
  <main>
    ...
    <div class="container container-wide">
      <div class="row">
        ...
        <div class="col-4 pt-3 text-end">
          <button :disabled="!got_hid_api" class="btn border border-secondary tertiary-bg btn-sm mx-4 rounded-0" @click="scan_hid()">
            Scan
          </button>
          <DarkMode />
    ...
    <Modal v-model="notSupportedModel" maxwidth="30%" closeable header="Web MIDI API not found">
      ...
      <div class="row mt-3">
        <div class="col text-center">
          Find out which browsers will work <a href="https://caniuse.com/midi" target="_blank" rel="noreferrer noopener">here</a>
        </div>
      </div>
    </Modal>
  </main>
