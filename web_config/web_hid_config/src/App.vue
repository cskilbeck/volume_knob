    ...
    <div class="container container-wide">
      <div class="row">
        ...
        <div class="col-2 pt-3 text-end">
          <button :disabled="!got_hid_api" class="btn border border-secondary tertiary-bg btn-sm mx-4" @click="scan_hid()">
            Scan
          </button>
          <DarkMode />
    ...
    <Modal v-model="closeableModal" maxwidth="30%" closeable header="It's a Configurator for the Tiny USB Knob">
      ...
      <div class="row mt-3">
        ...
        <div class="col-6 text-center">
          Crafted with care by <a class="" href="https://twitter.com/cskilbeck" target="_blank" rel="noreferrer noopener">@cskilbeck</a>
        </div>
        <div class="col-3 text-end">
          <a href="https://github.com/cskilbeck/volume_knob" target="_blank" rel="noreferrer noopener" class="link-body-emphasis">
          ...
          <a href="https://vuejs.org" target="_blank" rel="noreferrer noopener"> <svg viewBox="0 0 128 128" width="24" height="24">
